...
class TacticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tactic" do
    assert_difference('Tactic.count') do
      post tactics_url, params: { tactic: { description: @tactic.description, title: @tactic.title } }
    end
  ...
  test "should update tactic" do
    patch tactic_url(@tactic), params: { tactic: { description: @tactic.description, title: @tactic.title } }
